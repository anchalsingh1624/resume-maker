...
GOOGLE_APT_KEY = st.sidebar.text_input("Google API Key",type='password' )
GROQ_API_KEY = st.sidebar.text_input("Groq API Key",type='password' )
TAVILY_API_KEY = st.sidebar.text_input("Tavily API Key",type='password' )

if not GOOGLE_API_KEY:
  st.warning("provide Google Key")
...
def prompt_generator():
  ...
  maker, Iwant you to use chain-of-thoughts
...
profile_url= "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2UXIEw88o1zVkOZPUQ4Mu-Zw5eaI6wVZRn3JkPHAy3ne2vi2yVk9QvLgJ&s=10"

user_info = st.text_input('Give Your Info')
user_info = st.sidebar.file_uploader widget("upload pic", type = "image/jpeg")

user_query = f"""make a resume for a python developer.
